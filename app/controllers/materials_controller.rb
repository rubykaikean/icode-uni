class MaterialsController < ApplicationController
  ...
  private
    ...
    def material_params
      params.require(:material).permit(:description, :name,:created_at , :updated_at , :price_fomular_id,:material_code , :wt_ibs_ft,  :thk_dia , :thk_dia_um , :dimension_h , :dimension_w , :plate , :category_id , :unit_measure)
    end
